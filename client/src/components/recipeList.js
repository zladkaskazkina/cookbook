...
const recipesList = [
    {
        ...
        ingredients: [
            ...
            {name: "pražená piniová semínka", quantity: {measure: "hrst", amount: 1}},
            {name: "pepř mletý", quantity: {measure: "", amount: ""}}

        ],
        method: "Cizrnu přidejte do mixéru, přilijte veškeré tekutiny (ale jen 100 ml oleje), přidejte tahini, kmín, červenou papriku a česnek.\n" +
            "\n" +
    ...
    },
    {
        ...
        method: "Pokud máte čas a náladu, tak dáme papriky na plech a strčíme na 15 minut do trouby, po 15 minutách přidáme cibuli na čtvrtky a česnek. Vrátíme do trouby na dalších 15 minut. Poté vyndáme, oloupeme papriky, cibuli i česnek a hodíme do mixéru. Ale já tento krok přeskočila a na chuti to neubralo.\n" +
            "\n" +
    ...
    },
    {
        ...
        ingredients: [
            ...
            {name: "jarní cibulka", quantity: {measure: "podle chuti", amount: ""}},
            {name: "chilli paprička", quantity: {measure: "ks", amount: 1}},
            {name: "panenský olivový olej", quantity: {measure: "lžíce", amount: 1}},
            {name: "sůl", quantity: {measure: "", amount: ""}},
            {name: "pepř mletý", quantity: {measure: "", amount: ""}}

        ],
        method: "Avokádo rozpulte, vyjměte pecku (nejlépe to jde tak, že do pecky zaseknete nůž a krouživým pohybem pecku vyndáte) a lžící vyberte dužinu. Dejte jí do misky nebo hmoždíře, přilijte trochu vylisované limetové nebo citronové šťávy a rozmačkejte na kaši. Pokud chcete, můžete přidat i lžíci olivového oleje.\n" +
            "\n" +
    ...
    },
    {
        ...
        method: "Dýni překrojíme na polovinu a pečeme ji 15-20 minut při 200 stupních doměkka.Po dopečení ji necháme vychladnout a následně ji oloupeme a vydlabeme z ní semínka.\n" +
            "\n" +
    ...
    },
    {
        ...
        method: "Hrášek vyndáme z mrazáku alespoň 10 minut před přípravou polévky. V hrnci na rozpáleném oleji osmahneme nadrobno nasekanou cibuli dosklovata.\n" +
    ...
    },
    {
        ...
        method: "V hrnci na rozpáleném oleji či másle orestujeme nadrobno nasekanou cibuli dosklovata.\n" +
    ...
    },
    {
        ...
        method: "Ve velkém hrnci vroucí osolené vody uvařte těstoviny al dente, trvá to přibližně 5–6 minut.\n" +
    ...
    },
    {
        ...
        method: "Sušené houby nechte trochu nasát ve sklenici s horkou vodou. Na másle a oleji (ten přidávejte, aby máslo sneslo vyšší teplotu) lehce osmažte cibulku. Přidejte rýži carnarolli (na jednu porci postačí hrst rýže), promíchejte a podlijte sběračkou horkého zeleninového vývaru.\n" +
            "\n" +
    ...
    },
    {
        ...
        method: "Okurky nakrájejte na větší špalíčky, rajčata na čtvrtky nebo osminky, cibule rozkrojte na čtvrtky a poté ještě rozdělte na jednotlivé plátky. Papriky očistěte, ­odstraňte jádřince i bílé žebroví a nakrájejte je na větší kousky.\n" +
            "\n" +
    ...
    },
    {
        ...
        ingredients: [
            ...
            {name: "extra virgin olivový olej", quantity: {measure: "ml", amount: 30}},
            {name: "bazalkové lístky", quantity: {measure: "hrst", amount: 1}},
            {name: "pepř mletý", quantity: {measure: "", amount: ""}},
            {name: "sůl", quantity: {measure: "", amount: ""}}
        ],
        method: "Mozzarellu nechte okapat. Rajčata omyjte, osušte a nakrájejte na plátky, nebo měsíćky.\n" +
    ...
    },
    {
        ...
        method: "Brambory ve slupce uvaříme v osolené vodě s kmínem doměkka. Scedíme je a ještě teplé je oloupeme. Necháme je vychladnout. Rozčtvrtíme, nakrájíme na plátky a vložíme do mísy.\n" +
            "\n" +
